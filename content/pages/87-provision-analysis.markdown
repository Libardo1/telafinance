title: Charge-off, Provision, and ALLL Analysis
category: page
...
Consider the crisis of 2008, clearly the most severe in the chart above. While there were clear signs of stress even before 2008, the full-blown panic did not manifest until later in 2008. The situation should have been clearer to investors and practitioners sooner, as provision and charge-offs skyrocketed past historical norms but, when living through a crisis on a day-to-day basis, there can be some delay. Indeed, it can take many years after the fact to truly grasp the full event of damage.
...
As with any exercise in data or analysis, checking one's work is important. The primary data set used in this article comes from the FR Y-9C call report. However, another data set from the FFIEC was used for benchmarking purposes. It can be seen that the behavior of provision between the two sets is very similar (see the blue line versus the black dotted line above), providing further support to the estimates used in determining the "true" historical behavior.
...
In the charge-off versus recovery rate chart, the minimal influence of recoveries is apparent. First, the charge off curve is very similar to the curve seen for net-charge offs in the first chart. Second, the axis for recoveries is a tenth of the axis for charge-offs.

That being said, recoveries are still worth mention and review. The trend is straightforward. Recoveries decrease towards the end of an economic cycle, reaching a low point through the crisis. It makes sense from a crisis standpoint as businesses aren't as focused on fixing past-due defaults as they are on keeping the lights on. However, as a business cycle matures, the amount of defaults available for recovery shrinks, as defaults become less common over time. A business can't offer a recovery if they haven't been defaulting. Post-crisis, the behavior is expected - recoveries rise as defaults are recovered once businesses are able to survive the shock.

In summary, provision is a major driver of income statement behavior during times of stress. In the forecasting section for the <a href="/income-statement-forecasting.html">income statement</a>, provision is the primary driver for the overall shape of the net income curve in each scenario. Understanding charge-offs, recoveries, and ALLL allow analysts to better understand the credit loss framework and make inference about a bank's ability to absorb shocks through either their allowance buffer or their income statement. Charge-offs and provision also act as an early warning indicator for periods of stress and upticks should be treated seriously, as they may be just an initial proportion of a potentially normally-distributed rise.
