...
meta: Here we cover the broader characteristics of the total banking income statement before exploring the detailed components.

# Income Statement Analysis

## Net Income

<img src="/img/income-statement-analysis/NetIncome01Q1to16Q4.png" width="100%" alt="Net Income" class="technical-diagram">

## Segmentation

<img src="/img/income-statement-analysis/NetIncomeComponents01Q1to16Q4.png" width="100%" alt="Net Income Components" class="technical-diagram">
